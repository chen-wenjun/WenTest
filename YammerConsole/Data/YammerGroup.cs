...
{
    /// <summary>
    /// You get an entirely different data structure back when you query for a list of groups, versus
    /// when you get the list of feeds and groups that a user belongs to.  This structure is meant 
    /// just for enumerating the list of groups
    /// </summary>
    [DataContract]
